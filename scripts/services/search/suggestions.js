...
export const suggestSearchTerms = (query) => new Promise((resolve, reject) => {
  const suggestions = new Promise((resolve) => resolve(HARDCODED_TERMS));
...
// Copy-paste of search.gov search terms
// NOTE: If we used this method for suggestions, we would need to curate the
// list and make easier for content editors to work with.
